...
#SBATCH -J ndgp
#SBATCH --output=logs/ndgp_%A_%a.out
#SBATCH --error=logs/ndgp_%A_%a.err
...
DATA_ROOT="/cosma8/data/dp203/bl267/Data/MG_Arepo_runs/FORGE-BRIDGE/BRIDGE/Particle_Snapshots"
OUT_BASE="/cosma8/data/dp203/dc-pedr3/gravitomagnetic/output/ndgp"
...
for snap in $(seq 26 $MAX_SNAP); do
